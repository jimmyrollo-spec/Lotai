...
export function OfficialParcelGraphic({ geometry, location, floodIntersects }: Props) {
  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.graphic}>
        <svg viewBox="0 0 100 100" role="img" aria-label="Official parcel boundary from City of Austin GIS">
          <defs>
        ...
        <span className={styles.source}>COA GIS · TCAD PARCEL</span>
      </div>
